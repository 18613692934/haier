...
private $sex;
    ...
    public function test(){
            ...
            $appKey="a8c83cbafa484aea99dce5b5dd9a97c1"; //主账户key
            $appSecret="3ba934c1e5c54f090b7516d1b4976362"; //主账户secret
        ...
        $url1 = "https://open.ys7.com/api/lapp/live/video/list";
        $data1 = array("accessToken"=>$accessToken);
         $access = $this->request_post($url1,$data1);
         $access = json_decode($access , true);
         var_dump($access);
        
         
         $url2 = "https://open.ys7.com/api/lapp/device/capture";
         $deviceSerial = $access['data'][2]['deviceSerial'];
         $channelNo = $access['data'][2]['channelNo'];
         $data2 = array("accessToken"=>$accessToken,"deviceSerial"=>$deviceSerial,"channelNo"=>$channelNo);
         $access2 = $this->request_post($url2,$data2);
          $access2 = json_decode($access2 , true);
         $url7 = $access2['data']['picUrl'];
         
         $save_dir = '121/'.date('Y-m-d');
         $filename = date('YmdHis').'.jpg';
        $public =  new \Home\Controller\PublicController();
        $img = $public->getImage($url7, $save_dir, $filename);
         var_dump($img);
         exit;
